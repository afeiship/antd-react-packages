...
export class AcCheckboxGroup extends React.Component<Props> {
  ...
  render() {
    const { className, items, template, onChange, onSearch, children, ...props } = this.props;
    return (
      <Checkbox.Group className={cx(CLASS_NAME, className)} onChange={this.handleChange} {...props}>
